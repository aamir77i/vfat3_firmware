...
HD_PWD='F:/XAPP1026/KC705_AxiEth_150MHZ_64KB/vfat3_firmware/repo/edit_AXI_TX_CONTROLLER_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_TX_CONTROLLER_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_TX_CONTROLLER_v1_0.tcl

...
HD_PWD='F:/XAPP1026/KC705_AxiEth_150MHZ_64KB/vfat3_firmware/repo/edit_AXI_TX_CONTROLLER_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_TX_CONTROLLER_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_TX_CONTROLLER_v1_0.tcl -notrace

...
################################################################
# This is a generated script based on design: bd_1ed2
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Physical_Interface {GMII} \
  ...
  connect_bd_intf_net -intf_net mac_gmii [get_bd_intf_ports gmii] [get_bd_intf_pins mac/gmii]

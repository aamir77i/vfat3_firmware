...
HD_PWD='F:/XAPP1026/KC705_AxiEth_150MHZ_64KB/vfat3_firmware/HW/project_vbv3b/project_vbv3b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_subsystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_subsystem_wrapper.tcl
